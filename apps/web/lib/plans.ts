...
export const PLANS: Record<PlanId, Plan> = {
  standard: {
    id: 'standard',
    name: 'Standard',
    priceLabelMonthly: '$6.99',
    priceLabelAnnual: '$69.90',
    priceCentsMonthly: 699,
    priceCentsAnnual: 6990,
    backfillCap: 1000,
    maxBackfillDays: 240,
  ...
  premium: {
    id: 'premium',
    name: 'Premium',
    priceLabelMonthly: '$10.99',
    priceLabelAnnual: '$109.90',
    priceCentsMonthly: 1099,
    priceCentsAnnual: 10990,
    backfillCap: 3000,
    maxBackfillDays: 365,
    monthlyClassifierCap: 30_000,
    inboxLimit: 5,
    features: [
      'Up to 5 Gmail inboxes',
